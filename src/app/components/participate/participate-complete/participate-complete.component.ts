...
@Component({
  selector: 'app-participate-complete',
  standalone: true,
  imports: [
    MatRadioModule,
    FormsModule,
  ...
  templateUrl: './participate-complete.component.html',
  styleUrl: './participate-complete.component.scss',
  animations: [
    trigger('slideInOut', [
      transition(':enter', [
...
export class ParticipateCompleteComponent {
