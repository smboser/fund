...
@Component({
  selector: 'app-member-fundraising-page',
  standalone: true,
  imports: [
    MatRadioModule,
    FormsModule,
  ...
  templateUrl: './member-fundraising-page.component.html',
  styleUrl: './member-fundraising-page.component.scss',
  animations: [
    trigger('slideInOut', [
      transition(':enter', [
...
export class MemberFundraisingPageComponent {
  ...
  isBackEnabled = true;
  form!: FormGroup;
  nextForm = 'participate/member-start-donation';
