...
@Component({
  selector: 'app-member-start-donation',
  standalone: true,
  imports: [
    MatRadioModule,
    FormsModule,
  ...
  templateUrl: './member-start-donation.component.html',
  styleUrl: './member-start-donation.component.scss',
  animations: [
    trigger('slideInOut', [
      transition(':enter', [
...
export class MemberStartDonationComponent {
  ...
  isBackEnabled = true;
  form!: FormGroup;
  nextForm = 'participate/member-summary';
