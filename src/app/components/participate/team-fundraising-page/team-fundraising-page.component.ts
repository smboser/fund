...
@Component({
  selector: 'app-team-fundraising-page',
  standalone: true,
  imports: [
    MatRadioModule,
    FormsModule,
  ...
  templateUrl: './team-fundraising-page.component.html',
  styleUrl: './team-fundraising-page.component.scss',
  animations: [
    trigger('slideInOut', [
      transition(':enter', [
...
export class TeamFundraisingPageComponent {
  ...
  isBackEnabled = true;
  form!: FormGroup;
  nextForm = 'participate/team-start-donation';
