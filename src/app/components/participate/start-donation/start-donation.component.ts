...
@Component({
  ...
  templateUrl: './start-donation.component.html',
  styleUrl: './start-donation.component.scss',
  animations: [
    trigger('slideInOut', [
      transition(':enter', [
...
export class StartDonationComponent {
